...
<div class="container  " style="width: 90%">
	...
	<h2 class=" text-danger text-center "> All Users Data</h2> <hr>
  <table class="table table-striped table-bordered" id="x">
    ...
    while($row=mysqli_fetch_array($r))
    {
      ...
      <td> <a href="mangeusers.php?m='.$row['id'].'" class="btn btn-info btn-s "> 
      <i class="glyphicon glyphicon-trash "></i> </a> </td> 


      <td> <a href="edituser.php? id='.$row['id'].'" class="btn btn-info btn-s"> 
